...
int main(int argc, char *argv[]){
	...
	for(size_t i = 0 ; i < cameras.size(); i++){
		for(size_t j = 0; j < tie_points.size(); j++){
			...
			projection_perspective_camera_tait_bryan_wc(kp.u, kp.v, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy, pose.px, pose.py, pose.pz, pose.om, pose.fi, pose.ka, tie_points[j].x(), tie_points[j].y(), tie_points[j].z());
		...
		case 't':{
			...
			for(size_t i = 0; i < cameras.size(); i++){
				for(size_t j = 0; j < cameras[i].key_points.size(); j++){
					...
					observation_equation_perspective_camera_tait_bryan_wc(delta, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy,
					...
					observation_equation_perspective_camera_tait_bryan_wc_jacobian(jacobian, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy,
							pose.px, pose.py, pose.pz, pose.om, pose.fi, pose.ka,
							tie_points[cameras[i].key_points[j].index_to_tie_point].x(), tie_points[cameras[i].key_points[j].index_to_tie_point].y(), tie_points[cameras[i].key_points[j].index_to_tie_point].z());
		...
		case 'r':{
			...
			for(size_t i = 0; i < cameras.size(); i++){
				for(size_t j = 0; j < cameras[i].key_points.size(); j++){
					...
					Eigen::Matrix<double, 2, 1> delta;
					observation_equation_perspective_camera_rodrigues_wc(delta, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy, pose.px, pose.py, pose.pz, pose.sx, pose.sy, pose.sz,
							tie_points[cameras[i].key_points[j].index_to_tie_point].x(), tie_points[cameras[i].key_points[j].index_to_tie_point].y(), tie_points[cameras[i].key_points[j].index_to_tie_point].z(),
							std::floor(cameras[i].key_points[j].u), std::floor(cameras[i].key_points[j].v));

					Eigen::Matrix<double, 2, 9, Eigen::RowMajor> jacobian;
					observation_equation_perspective_camera_rodrigues_wc_jacobian(jacobian, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy, pose.px, pose.py, pose.pz, pose.sx, pose.sy, pose.sz,
							tie_points[cameras[i].key_points[j].index_to_tie_point].x(), tie_points[cameras[i].key_points[j].index_to_tie_point].y(), tie_points[cameras[i].key_points[j].index_to_tie_point].z());
		...
		case 'q':{
			...
			for(size_t i = 0; i < cameras.size(); i++){
				for(size_t j = 0; j < cameras[i].key_points.size(); j++){
					...
					Eigen::Matrix<double, 2, 1> delta;
					observation_equation_perspective_camera_quaternion_wc(delta, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy, pose.px, pose.py, pose.pz, pose.q0, pose.q1, pose.q2, pose.q3,
							tie_points[cameras[i].key_points[j].index_to_tie_point].x(), tie_points[cameras[i].key_points[j].index_to_tie_point].y(), tie_points[cameras[i].key_points[j].index_to_tie_point].z(),
							std::floor(cameras[i].key_points[j].u), std::floor(cameras[i].key_points[j].v));

					Eigen::Matrix<double, 2, 10, Eigen::RowMajor> jacobian;
					observation_equation_perspective_camera_quaternion_wc_jacobian(jacobian, cam_params.fx, cam_params.fy, cam_params.cx, cam_params.cy, pose.px, pose.py, pose.pz, pose.q0, pose.q1, pose.q2, pose.q3, tie_points[cameras[i].key_points[j].index_to_tie_point].x(), tie_points[cameras[i].key_points[j].index_to_tie_point].y(), tie_points[cameras[i].key_points[j].index_to_tie_point].z());

...
all_symbols = position_symbols_1 + orientation_symbols_1 + [s_1] + position_symbols_2 + orientation_symbols_2 + [s_2]
...
transformed_point_1 = ( matrix44FromTaitBryan(px_1, py_1, pz_1, om_1, fi_1, ka_1) * m_scale_1 * point_1)[:-1,:]
...
transformed_point_2 = ( matrix44FromTaitBryan(px_2, py_2, pz_2, om_2, fi_2, ka_2) * m_scale_2 * point_2)[:-1,:]
...
with open("point_to_point_with_scale_tait_bryan_wc_jacobian.h",'w') as f_cpp:  
    f_cpp.write("inline void point_to_point_with_scale_tait_bryan_wc(double &delta_x, double &delta_y, double &delta_z, double px_1, double py_1, double pz_1, double om_1, double fi_1, double ka_1, double px_2, double py_2, double pz_2, double om_2, double fi_2, double ka_2, double x_1, double y_1, double z_1, double x_2, double y_2, double z_2, double s_1, double s_2)\n")
    f_cpp.write("{")
    ...
    f_cpp.write("}")
    f_cpp.write("\n")
    f_cpp.write("inline void point_to_point_with_scale_tait_bryan_wc_jacobian(Eigen::Matrix<double, 3, 14, Eigen::RowMajor> &j, double px_1, double py_1, double pz_1, double om_1, double fi_1, double ka_1, double px_2, double py_2, double pz_2, double om_2, double fi_2, double ka_2, double x_1, double y_1, double z_1, double x_2, double y_2, double z_2, double s_1, double s_2)\n")
    f_cpp.write("{")
    for i in range (3):
        for j in range (14):

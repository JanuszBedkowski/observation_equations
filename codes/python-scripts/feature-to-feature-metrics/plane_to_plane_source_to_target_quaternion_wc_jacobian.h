#ifndef _plane_to_plane_source_to_target_quaternion_wc_jacobian_h_
#define _plane_to_plane_source_to_target_quaternion_wc_jacobian_h_
...
delta.coeffRef(3,0) = -a_1*(tx_1*(2*pow(q2_1, 2) + 2*pow(q3_1, 2) - 1) + ty_1*(-2.0*q0_1*q3_1 - 2.0*q1_1*q2_1) + tz_1*(2.0*q0_1*q2_1 - 2.0*q1_1*q3_1)) - b_1*(tx_1*(2.0*q0_1*q3_1 - 2.0*q1_1*q2_1) + ty_1*(2*pow(q1_1, 2) + 2*pow(q3_1, 2) - 1) + tz_1*(-2.0*q0_1*q1_1 - 2.0*q2_1*q3_1)) - c_1*(tx_1*(-2.0*q0_1*q2_1 - 2.0*q1_1*q3_1) + ty_1*(2.0*q0_1*q1_1 - 2.0*q2_1*q3_1) + tz_1*(2*pow(q1_1, 2) + 2*pow(q2_1, 2) - 1)) - d_1 + d_2;
}
inline void plane_to_plane_source_to_target_quaternion_wc_jacobian(Eigen::Matrix<double, 4, 7, Eigen::RowMajor> &j, double tx_1, double ty_1, double tz_1, double q0_1, double q1_1, double q2_1, double q3_1, double a_1, double b_1, double c_1, double d_1, double a_2, double b_2, double c_2, double d_2)
{j.coeffRef(0,0) = 0;
j.coeffRef(0,1) = 0;
j.coeffRef(0,2) = 0;
...
j.coeffRef(3,3) = -a_1*(2.0*q2_1*tz_1 - 2.0*q3_1*ty_1) - b_1*(-2.0*q1_1*tz_1 + 2.0*q3_1*tx_1) - c_1*(2.0*q1_1*ty_1 - 2.0*q2_1*tx_1);
j.coeffRef(3,4) = -a_1*(-2.0*q2_1*ty_1 - 2.0*q3_1*tz_1) - b_1*(-2.0*q0_1*tz_1 + 4*q1_1*ty_1 - 2.0*q2_1*tx_1) - c_1*(2.0*q0_1*ty_1 + 4*q1_1*tz_1 - 2.0*q3_1*tx_1);
j.coeffRef(3,5) = -a_1*(2.0*q0_1*tz_1 - 2.0*q1_1*ty_1 + 4*q2_1*tx_1) - b_1*(-2.0*q1_1*tx_1 - 2.0*q3_1*tz_1) - c_1*(-2.0*q0_1*tx_1 + 4*q2_1*tz_1 - 2.0*q3_1*ty_1);
j.coeffRef(3,6) = -a_1*(-2.0*q0_1*ty_1 - 2.0*q1_1*tz_1 + 4*q3_1*tx_1) - b_1*(2.0*q0_1*tx_1 - 2.0*q2_1*tz_1 + 4*q3_1*ty_1) - c_1*(-2.0*q1_1*tx_1 - 2.0*q2_1*ty_1);
}
#endif
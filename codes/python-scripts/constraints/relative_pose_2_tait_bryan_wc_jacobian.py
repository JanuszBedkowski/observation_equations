...
Rt_wc_m = matrix44FromTaitBryan(tx_m, ty_m, tz_m, om_m, fi_m, ka_m)
#Rt_wc_m = matrix44FromTaitBryan(tx_m, ty_m, tz_m, sx_m, sy_m, sz_m)
#Rt_wc_m = matrix44FromTaitBryan(tx_m, ty_m, tz_m, q0_2, q1_2, q2_2, q3_2)
...
t_wc_m=Matrix([tx_m, ty_m, tz_m]).vec()
...
with open("relative_pose_2_tait_bryan_wc_jacobian.h",'w') as f_cpp:  
    f_cpp.write("inline void relative_pose_2_obs_eq_tait_bryan_wc_case1(Eigen::Matrix<double, 6, 1> &delta, double tx_1, double ty_1, double tz_1, double om_1, double fi_1, double ka_1, double tx_2, double ty_2, double tz_2, double om_2, double fi_2, double ka_2, double tx_m, double ty_m, double tz_m, double om_m, double fi_m, double ka_m)\n")
    f_cpp.write("{")
    for i in range (6):

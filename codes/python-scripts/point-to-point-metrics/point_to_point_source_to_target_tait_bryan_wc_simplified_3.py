...
substitutions = [(sympy.sin(om), 0), (sympy.cos(om), 1), (sympy.sin(
...
with open("point_to_point_source_to_target_tait_bryan_wc_jacobian_simplified_3.h",'w') as f_cpp:  
    f_cpp.write("#ifndef _point_to_point_source_to_target_tait_bryan_wc_jacobian_simplified_3_h_\n")
    f_cpp.write("#define _point_to_point_source_to_target_tait_bryan_wc_jacobian_simplified_3_h_\n")
    f_cpp.write("inline void point_to_point_source_to_target_tait_bryan_wc_simplified_3(double &delta_x, double &delta_y, double &delta_z, const double &tx, const double &ty, const double &tz, const double &om, const double &fi, const double &ka, const double &x_s, const double &y_s, const double &z_s, const double &x_t, const double &y_t, const double &z_t)\n")
    f_cpp.write("{\n")
    ...
    f_cpp.write("}")
    f_cpp.write("\n")
    f_cpp.write("inline void point_to_point_source_to_target_tait_bryan_wc_jacobian_simplified_3(Eigen::Matrix<double, 3, 6, Eigen::RowMajor> &j, const double &tx, const double &ty, const double &tz, const double &om, const double &fi, const double &ka, const double &x_s, const double &y_s, const double &z_s)\n")
    f_cpp.write("{\n")
    ...
    f_cpp.write("}\n")
    f_cpp.write("inline void point_to_point_source_to_target_tait_bryan_wc_AtPA_simplified_3(Eigen::Matrix<double, 6, 6, Eigen::RowMajor> &AtPA, const double &tx, const double &ty, const double &tz, const double &om, const double &fi, const double &ka, const double &x_s, const double &y_s, const double &z_s)\n")
    f_cpp.write("{\n")
    ...
    f_cpp.write("}\n")
    f_cpp.write("inline void point_to_point_source_to_target_tait_bryan_wc_AtPB_simplified_3(Eigen::Matrix<double, 6, 1> &AtPB, const double &tx, const double &ty, const double &tz, const double &om, const double &fi, const double &ka, const double &x_s, const double &y_s, const double &z_s, const double &x_t, const double &y_t, const double &z_t)\n")
    f_cpp.write("{\n")

...
inline void point_to_point_source_to_target_tait_bryan_wc_AtPA_simplified_precomputed_trig(Eigen::Matrix<double, 6, 6, Eigen::RowMajor> &AtPA, double tx, double ty, double tz, double sin_om, double cos_om, double sin_fi, double cos_fi, double sin_ka, double cos_ka, double x_s, double y_s, double z_s, double p11, double p12, double p13, double p21, double p22, double p23, double p31, double p32, double p33)
{
double x0 = cos_ka*sin_om;
double x1 = cos_om*sin_ka;
double x2 = sin_fi*x1 + x0;
...
inline void point_to_point_source_to_target_tait_bryan_wc_AtPB_simplified_precomputed_trig(Eigen::Matrix<double, 6, 1> &AtPB, double tx, double ty, double tz, double sin_om, double cos_om, double sin_fi, double cos_fi, double sin_ka, double cos_ka, double x_s, double y_s, double z_s, double p11, double p12, double p13, double p21, double p22, double p23, double p31, double p32, double p33, double x_t, double y_t, double z_t)
{
double x0 = cos_ka*x_s;
double x1 = sin_ka*y_s;
double x2 = cos_fi*x0 - cos_fi*x1 + sin_fi*z_s;

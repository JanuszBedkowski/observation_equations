...
double x12 = sin_fi*x3 + x4;
double x13 = -sin_fi*x6 + x7;
AtPB.coeffRef(0,0) = p11*(cos_fi*cos_ka*x_s - cos_fi*sin_ka*y_s + sin_fi*z_s + tx - x_t) + p12*(-cos_fi*sin_om*z_s + ty + x_s*(cos_ka*sin_fi*sin_om + cos_om*sin_ka) + y_s*(cos_ka*cos_om - sin_fi*sin_ka*sin_om) - y_t) + p13*(cos_fi*cos_om*z_s + tz - x_s*(cos_ka*cos_om*sin_fi - sin_ka*sin_om) + y_s*(cos_ka*sin_om + cos_om*sin_fi*sin_ka) - z_t);

...
all_symbols = position_symbols_1 + orientation_symbols_1 + position_symbols_c + orientation_symbols_c
...
transformed_point_1 = (  
matrix44FromTaitBryan(tx_1, ty_1, tz_1, om_1, fi_1, ka_1) * matrix44FromTaitBryan(tx_c, ty_c, tz_c, om_c, fi_c, ka_c) * point_1)[:-1,:]
...
with open("point_to_target_hpp_tait_bryan_wc_jacobian.h",'w') as f_cpp:  
    f_cpp.write("inline void point_to_target_hpp_tait_bryan_wc(double &delta_x, double &delta_y, double &delta_z, double tx_1, double ty_1, double tz_1, double om_1, double fi_1, double ka_1, double tx_c, double ty_c, double tz_c, double om_c, double fi_c, double ka_c, double x_1, double y_1, double z_1, double x_t, double y_t, double z_t)\n")
    f_cpp.write("{")
    ...
    f_cpp.write("}")
    f_cpp.write("\n")
    f_cpp.write("inline void point_to_target_hpp_tait_bryan_wc_jacobian(Eigen::Matrix<double, 3, 12, Eigen::RowMajor> &j, double tx_1, double ty_1, double tz_1, double om_1, double fi_1, double ka_1, double tx_c, double ty_c, double tz_c, double om_c, double fi_c, double ka_c, double x_1, double y_1, double z_1, double x_t, double y_t, double z_t)\n")
    f_cpp.write("{")
    for i in range (3):
        for j in range (12):

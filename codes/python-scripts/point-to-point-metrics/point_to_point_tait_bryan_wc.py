...
transformed_point_1 = (matrix44FromTaitBryan(tx_1, ty_1, tz_1, om_1, fi_1, ka_1) * point_1)[:-1,:]
#transformed_point_1 = (matrix44FromRodrigues(tx_1, ty_1, tz_1, sx_1, sy_1, sz_1) * point_1)[:-1,:]
#transformed_point_1 = (matrix44FromQuaternion(tx_1, ty_1, tz_1, q0_1, q1_1, q2_1, q3_1) * point_1)[:-1,:]
transformed_point_2 = (matrix44FromTaitBryan(tx_2, ty_2, tz_2, om_2, fi_2, ka_2) * point_2)[:-1,:]
#transformed_point_2 = (matrix44FromRodrigues(tx_2, ty_2, tz_2, sx_2, sy_2, sz_2) * point_2)[:-1,:]
#transformed_point_2 = (matrix44FromQuaternion(tx_2, ty_2, tz_2, q0_2, q1_2, q2_2, q3_2) * point_2)[:-1,:]
...
with open("point_to_point_tait_bryan_wc_jacobian.h",'w') as f_cpp:  
    f_cpp.write("inline void point_to_point_tait_bryan_wc(double &delta_x, double &delta_y, double &delta_z, double tx_1, double ty_1, double tz_1, double om_1, double fi_1, double ka_1, double tx_2, double ty_2, double tz_2, double om_2, double fi_2, double ka_2, double x_1, double y_1, double z_1, double x_2, double y_2, double z_2)\n")
    f_cpp.write("{")

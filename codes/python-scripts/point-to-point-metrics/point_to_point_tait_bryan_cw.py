...
with open("point_to_point_tait_bryan_cw_jacobian.h",'w') as f_cpp:  
    f_cpp.write("inline void point_to_point_tait_bryan_cw(double &delta_x, double &delta_y, double &delta_z, double px_1, double py_1, double pz_1, double om_1, double fi_1, double ka_1, double px_2, double py_2, double pz_2, double om_2, double fi_2, double ka_2, double x_1, double y_1, double z_1, double x_2, double y_2, double z_2)\n")
    f_cpp.write("{")
